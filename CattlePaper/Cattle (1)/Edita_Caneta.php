...
<div class="container">
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			...
			<div class="card-body">
				<form method="post" action="editar_caneta.php">
                
                  <select name="caneta_edita">
                  <option>Selecione a Caneta</option>
                      <?php
                           include 'db.php';
                ...
                <div class="input-group form-group">
						<input type="text" class="form-control" name = "nome_caneta" placeholder="Nome do Caneta">						
					</div>
					<div class="input-group form-group">
