	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<h3>Cadastrar Caneta</h3>
			</div>
			<div class="card-body">
      <form method="post" action="inserir_caneta.php">
					<div class="input-group form-group">
						<input type="text" class="form-control" name = "nome_caneta" placeholder="Nome da Caneta">						
					</div>
					<div class="input-group form-group">
            <input type="text" class="form-control"  name ="tipo_caneta" placeholder="Tipo">
					</div>          
					<div class="input-group form-group">
            <input type="number" class="form-control"  name = "preco_caneta" placeholder="Preço">
					</div>
