	...
	<div class="d-flex justify-content-center h-100">
		<div class="card">
			<div class="card-header">
				<h3>Deletar Caderno</h3>
			</div>
			<div class="card-body">
				<form method="post" action="processa_caderno.php">
                
                <select name="idcaderno">
                    <option>Selecione o Caderno</option>
                        <?php
                             include 'db.php';
                             while($linha = mysqli_fetch_array($consulta_caderno)){
                             echo '<option value="'.$linha['id_caderno'].'">'.$linha['nome_caderno'].'</option>';
                             }
                         ?>
                </select>
          ...
          <a href="Caderno.php" class="btn float-left login_btn" >Voltar</a>
				</form>
			</div>
			</div>
		</div>
